...
#[cfg(all(feature = "Wdk_Foundation", feature = "Win32_Security", feature = "Win32_System_IO"))]
#[inline]
pub unsafe fn NtCreateNamedPipeFile(filehandle: *mut super::super::super::Win32::Foundation::HANDLE, desiredaccess: u64, objectattributes: *const super::super::Foundation::OBJECT_ATTRIBUTES, iostatusblock: *mut super::super::super::Win32::System::IO::IO_STATUS_BLOCK, shareaccess: u64, createdisposition: u64, createoptions: u64, namedpipetype: u64, readmode: u64, completionmode: u64, maximuminstances: u64, inboundquota: u64, outboundquota: u64, defaulttimeout: Option<*const i64>) -> super::super::super::Win32::Foundation::NTSTATUS {
    windows_link::link!("ntdll.dll" "system" fn NtCreateNamedPipeFile(filehandle : *mut super::super::super::Win32::Foundation:: HANDLE, desiredaccess : u64, objectattributes : *const super::super::Foundation:: OBJECT_ATTRIBUTES, iostatusblock : *mut super::super::super::Win32::System::IO:: IO_STATUS_BLOCK, shareaccess : u64, createdisposition : u64, createoptions : u64, namedpipetype : u64, readmode : u64, completionmode : u64, maximuminstances : u64, inboundquota : u64, outboundquota : u64, defaulttimeout : *const i64) -> super::super::super::Win32::Foundation:: NTSTATUS);
    unsafe { NtCreateNamedPipeFile(filehandle as _, desiredaccess, objectattributes, iostatusblock as _, shareaccess, createdisposition, createoptions, namedpipetype, readmode, completionmode, maximuminstances, inboundquota, outboundquota, defaulttimeout.unwrap_or(core::mem::zeroed()) as _) }
}
#[cfg(all(feature = "Wdk_Foundation", feature = "Win32_Security"))]
#[inline]
